...
| Paper | `../SensitivityFunctionalInformationPaper` @ 4303886 (2026-08-12). 30-page seminar build (non-anonymous, \iclrfinalcopy). **All 08-14 review findings still open.** ICLR 2027: 9 pages main text at submission, deadlines 09-18/09-25 AoE. |
